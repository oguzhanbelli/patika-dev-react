...
function Footer() {
  return (
    <div>
      <hr className="mt-2 mb-4 border-slate-800 dark:border-slate-800" />
      <div className="sm:flex sm:items-center sm:justify-between">
        <span className="text-sm text-slate-700  sm:text-center dark:text-slate-800">
          © 2022{" "}
          <a
            href="https://linkedin.com/in/oguzhanbelli"
            target="_blank"
            rel="noreferrer"
        ...
        <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
          <a
            href="https://github.com/oguzhanbelli"
            target="_blank"
            rel="noreferrer"
